	        ...
	        <div class="px-0 text-left py-2">
	          <table class="table table-striped">
	          	...
	          	<tr>
	          		...
	          		<td class="py-1">{{Auth::user()->employee->person->father_name}}</td>
	          	</tr>
	          	<tr>
	          		<th class="py-1">Nationality:</th>
	          		<td class="py-1">{{Auth::user()->employee->person->nationality->name}}</td>
	          	</tr>
	          	<tr>
	          		<th class="py-1">Date Of Birth:</th>
	          		<td class="py-1">{{Auth::user()->employee->person->date_of_birth}}</td>
	          	</tr>
	          	<tr>
	          		<th class="py-1">Gender:</th>
	          		<td class="py-1">{{Auth::user()->employee->person->gender}}</td>
	          	</tr>
	          	<tr>
	          		<th class="py-1">Phone:</th>
	          		<td class="py-1">{{Auth::user()->employee->person->phones[0]->number}}</td>
	          	</tr>
	          </table>
	          <hr>
	        </div>
